...
console.log('CONTENT_of_createAsset:', content)
...
function createGraph(entry) {
  ...
  console.log('MAINASSET_of_createGraph: ', mainAsset)
  ...
  console.log('QUEUE_in_createGraf', queue)
  return queue;
}
...
setTimeout(() => console.log("MODULES_in_string", modules), 1000)
...
setTimeout(() => console.log("R E S U L T: ", result), 2000)
console.log(result);
